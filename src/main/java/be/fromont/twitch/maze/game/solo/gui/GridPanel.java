...
import be.fromont.twitch.maze.game.solo.common.threads.ThreadVictory;
import be.fromont.twitch.maze.game.solo.model.Cell;
import be.fromont.twitch.maze.game.solo.model.Direction;
import be.fromont.twitch.maze.game.solo.model.Maze;
...
public class GridPanel extends JPanel implements KeyListener {
    ...
    private BufferedImage getBackgroundImage() {
        if (background == null) {
            try {
                background = ImageIO.read(new File("gui/background_solo.png"));
            } catch (IOException ex) {
                LOG.error("An error occurred while trying to load game settings : {}", ex);
            }
        }
